...
(function (global, factory) {
  ...
  var VirtualList = Vue__default["default"].component('virtual-list', {
    ...
    beforeDestroy: function beforeDestroy() {
      var _a, _b;
      (_a = this.sortableRef) === null || _a === void 0 ? void 0 : _a.destroy();
      (_b = this.virtualRef) === null || _b === void 0 ? void 0 : _b.removeScrollEventListener();
    },
    methods: {
      /**
      ...
      _onUpdate: function _onUpdate() {
        ...
        (_a = this.sortableRef) === null || _a === void 0 ? void 0 : _a.option('list', this.dataSource);
      ...
      _updateUniqueKeys: function _updateUniqueKeys() {
        ...
        (_a = this.virtualRef) === null || _a === void 0 ? void 0 : _a.option('uniqueKeys', this.uniqueKeys);
        (_b = this.sortableRef) === null || _b === void 0 ? void 0 : _b.option('uniqueKeys', this.uniqueKeys);
      },
      ...
      _installVirtual: function _installVirtual() {
        var _this4 = this;
        this.virtualRef = new Virtual(Object.assign(Object.assign({}, this.virtualAttributes), {
      ...
      _installSortable: function _installSortable() {
        var _this5 = this;
        this.sortableRef = new Sortable(this.$refs.rootRef, Object.assign(Object.assign({}, this.sortableAttributes), {
    ...
    render: function render(h) {
      ...
      return h(container, {
        ...
        style: Object.assign(Object.assign({}, this.wrapStyle), {
